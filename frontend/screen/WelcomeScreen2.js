  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.introWrapper}>
        <Text style={styles.introTitleText}>Dự đoán khả năng nhiễm bệnh</Text>
        <Text style={styles.introSubtitleText}>
          Dự đoán khả năng nhiệm bệnh Covid - 19 và các bệnh liên quan tới phổi
          dựa trên âm thanh tiếng ho người dùng cung cấp.
        </Text>
      </View>
